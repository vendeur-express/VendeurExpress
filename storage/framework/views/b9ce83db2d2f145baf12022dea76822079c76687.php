...
<body>
    <div class="page-wrapper">
            ...
            <div class="header-middle">
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="<?php echo e(route('client')); ?>" class="logo">
                    ...
                    <div class="header-right">
                        ...
                        <div class="wishlist">
                            <a href="<?php echo e(route('favorie')); ?>" title="Favories">
                                <div class="icon">
                        ...
                        <div class="dropdown cart-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="dropdown-cart-action">
                                    <a href="<?php echo e(route('panier')); ?>" class="btn btn-primary">Voir Panier</a>
                                    <a href="<?php echo e(route('paiement')); ?>" class="btn btn-outline-primary-2"><span>Commander</span><i class="icon-long-arrow-right"></i></a>
                                </div><!-- End .dropdown-cart-total -->
                        ...
                        <nav class="main-nav ">
                            <ul class="menu sf-arrows" >
                                <li class="megamenu-container active ">
                                    <a style="color: white" href="<?php echo e(route('client')); ?>" >Acceuil</a>
                                </li>
                                <li>
                                    <a style="color: white" href="<?php echo e(route('vexshop')); ?>" >Vex shop</a>
                                </li>
                                <li>
                                    <a style="color: white" href="<?php echo e(route('apropos')); ?>">A propos</a>
                                </li>
                                <li>
                                    <a style="color: white" href="<?php echo e(route('blog')); ?>" >Blog</a>
                                </li>
                                <li>
                                    <a style="color: white" href="<?php echo e(route('contact')); ?>" >Contactez-nous</a>
                                </li>
                                <li>
                                    <a style="color: white" href="<?php echo e(route('inscription')); ?>"> S'inscrire</a>
                                </li>
                            </ul><!-- End .menu -->
                        </nav><!-- End .main-nav -->
                    ...
                    <div class="tab-pane fade show active" id="mobile-menu-tab" role="tabpanel" aria-labelledby="mobile-menu-link">
                        <nav class="mobile-nav">
                            <ul class="mobile-menu">
                                <li class="active">
                                    <a href="<?php echo e(route('acceuil')); ?>">ACCEUIL</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('vexshop')); ?>">VEX SHOP</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('apropos')); ?>" class="sf-with-ul">A PROPOS</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="<?php echo e(route('inscription')); ?>">S'INSCRIRE</a>
                                </li>
                            </ul>
                        </nav><!-- End .mobile-nav -->
                    </div><!-- .End .tab-pane -->
	            		...
	            		<div class="col-sm-4 col-lg-3">
	            			<div class="widget">
	            				...
	            				<ul class="widget-list">
	            					...
	            					<li><a href="<?php echo e(route('vexshop')); ?>">VEX SHOP</a></li>
        ...
        <div  style="background-color: #001056">
            <div class="container">
                <div>
...
</html><?php /**PATH C:\Users\VEX\vendeurexpress-app\resources\views/layouts/client/app.blade.php ENDPATH**/ ?>