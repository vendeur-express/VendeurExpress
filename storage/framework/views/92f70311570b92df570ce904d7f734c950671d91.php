    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="has-treeview">
            <a href="<?php echo e(route('article')); ?>" class="nav-link">
          ...
          <li class="has-treeview">
            <a href="<?php echo e(route('supercommande')); ?>" class="nav-link">
          ...
          <li class="has-treeview">
            <a href="<?php echo e(route('superclient')); ?>" class="nav-link">
          ...
          <li class="has-treeview">
            <a href="<?php echo e(route('superproduit')); ?>" class="nav-link">
          ...
          <li class="has-treeview">
            <a href="<?php echo e(route('categorie')); ?>" class="nav-link">
          ...
          <li class="has-treeview">
            <a href="<?php echo e(route('supercoupon')); ?>" class="nav-link">
          ...
          <li class="has-treeview">
            <a href="<?php echo e(route('publicite')); ?>" class="nav-link">
          ...
          <li class="has-treeview">
            <a href="<?php echo e(route('banniere')); ?>" class="nav-link">
          ...
          <li class="has-treeview">
            <a href="<?php echo e(route('compte')); ?>" class="nav-link">
          ...
          <li class="has-treeview">
            <a href="<?php echo e(route('commentaire')); ?>" class="nav-link">
          ...
          <li class="has-treeview">
            <a href="<?php echo e(route('parametre')); ?>" class="nav-link">
              <i class="far fa-sun nav-icon"></i>
              <p>
                Réglages
              </p>
...
</html><?php /**PATH C:\Users\VEX\vendeurexpress-app\resources\views/layouts/superadmin/app.blade.php ENDPATH**/ ?>