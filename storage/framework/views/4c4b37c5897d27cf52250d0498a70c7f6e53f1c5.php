        ...
        <header class="header header-intro-clearance header-4">
            <div class="header-top">
                ...
                <div class="header-left">
                        <a href=""><i class="icon-localise"></i>   01 BP 6586 Ouagadougou 01</a>  
                    </div>
                    <div class="header-left">
                        ...
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                                <li class="megamenu-container active">
                                    <a href="<?php echo e(route('acceuil')); ?>" class="sf-with-ul">Acceuil</a>
                                </li>
                                <li>
...
</html><?php /**PATH C:\Users\VEX\vendeurexpress-app\resources\views/index.blade.php ENDPATH**/ ?>